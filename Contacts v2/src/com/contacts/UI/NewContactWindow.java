...
public class NewContactWindow {
	...
	private void initialize() {
		...
		frame.getContentPane()
				.add(textFieldHomeNumber, gbc_textFieldHomeNumber);
		...
		frame.getContentPane().add(textFieldMobileNumber,
				gbc_textFieldMobileNumber);
		...
		btnSave.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				core.getContactList().getJustAdded().setFirstName(
						textFieldFirstName.getText());
				core.getContactList().getJustAdded().setSurName(
						textFieldSurname.getText());
				core.getContactList().getJustAdded().setHomeNumber(
						textFieldHomeNumber.getText());
				core.getContactList().getJustAdded().setMobileNumber(
						textFieldMobileNumber.getText());
				core.getContactList().getJustAdded()
						.setCity(textFieldCity.getText());
				core.printContact(core.getContactList().getJustAdded());
